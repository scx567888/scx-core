...
public final class ScxRouteHandler {
    ...
    private static Object getValueFormPathAndQuery(String parameterName, Class<?> parameterType, Map<String, String> pathParams, Map<String, String> queryParams) {
    ...
    public Object getResult(FullHttpRequest ctx) {
        ...
        if (ctx.method() != HttpMethod.GET) {
            jsonStr = ctx.content().toString(StandardCharsets.UTF_8);
        }
