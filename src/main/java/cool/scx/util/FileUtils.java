...
public final class FileUtils {
     ...
     * 图片文件类型
     */
    private final static List<FileType> IMAGE_FILE_TYPE_LIST = getImageFileTypeList();

    /**
     * 其他文件类型
     */
    private final static List<FileType> OTHER_FILE_TYPE_LIST = getOtherFileType();

    /**
     * 所有文件类型
     */
    private final static List<FileType> ALL_FILE_TYPE_LIST = getAllFileType();
    ...
    private static List<FileType> getAllFileType() {
        var tempList = new ArrayList<FileType>();
        tempList.addAll(IMAGE_FILE_TYPE_LIST);
        tempList.addAll(OTHER_FILE_TYPE_LIST);
        return tempList;
    }
