...
public class AuthController {
     ...
     * @param scxLogService   a {@link cool.scx._core.system.ScxLogService} object.
     ...
     */
    public AuthController(UserService userService,  DeptService deptService, RoleService roleService, UserRoleService userRoleService, UserDeptService userDeptService) {
...
//        }
    ...
    public Json register(String username, String password) {
        var newUser = new Param<>(ScxContext.getBean(User.class));
     ...
     * <p>avatarUpdate.</p>
     *
     * @param queryUser a {@link cool.scx.base.BaseUser} object.
     * @return a {@link cool.scx.vo.Json} object.
     */
    @ScxMapping(useMethodNameAsUrl = true)
...
//        return Json.ok().items(byCondition);
    ...
    public Json listSubUser() {
        ...
        var queryUser = new Param<>(ScxContext.getBean(User.class));
        ...
        var p = new Param<>(ScxContext.getBean(Dept.class));
    ...
    public Json delete(Long id) {
        if (StringUtils.isNotEmpty(id)) {
            var dept = new Param<>(ScxContext.getBean(Dept.class));
    ...
    public Json listRole() {
        var param = new Param<>(ScxContext.getBean(Role.class));
