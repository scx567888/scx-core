...
public class RoleService extends BaseService<Role> {
     ...
     *
     * @param userRoleService a {@link cool.scx._ext.organization.UserRoleService} object.
     */
     ...
     * getRoleListByUser
     *
     * @param user a {@link cool.scx._ext.organization.User} object
...
//            roleParam.whereSql = " id in (" + collect + ")";
     ...
     *
     * @param userIds a {@link cool.scx._ext.organization.User} object
     * @return a {@link java.util.List} object
     */
